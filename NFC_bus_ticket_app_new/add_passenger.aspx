<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_passenger.aspx.cs" Inherits="add_passenger" %>
...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<div>
			<h3 class="style31">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Add Passenger Details</h3>
			</div>
		<center>
              ...
              <tr style="width: 100px">
                               <td class="style19"><asp:Label ID="lblfirst_namme" runat="server" 
                                ...
                                <td class="style20">
                                 ...
                                 <tr style="width: 100px">
                               <td class="style22">
                                   <asp:Label ID="lblmiddle_name" runat="server" 
                                       Text="Last Name :"></asp:Label></td>
                                <td class="style23">
                                    <asp:TextBox ID="txt_lastname" runat="server" CssClass="input-text" Width="170px" 
                                        Height="28px" ontextchanged="txt_lastname_TextChanged1"></asp:TextBox>
                                     </td>
                                        <td class="style24">
                          ...
                          <tr style="width: 100px">
                               <td class="style25">
                                   <asp:Label ID="Label1" runat="server" 
                                       Text="Pan Card No. :"></asp:Label></td>
                                <td class="style26">
                                    <asp:TextBox ID="txt_middlename" runat="server" Height="30px" Width="154px"></asp:TextBox>
                                </td>
                                    <td class="style27">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                            ControlToValidate="txt_middlename" ErrorMessage="Pan Card No is Requierd" 
                                            SetFocusOnError="True"></asp:RequiredFieldValidator>
                               </td></tr>
                               <tr style="width: 100px">
                               <td class="style28">
                        ...
                        <tr style="width: 100px">
                               ...
                               <td class="style25">
                                   <asp:Label ID="Label5" runat="server" 
                                       Text="Balance:"></asp:Label></td>
                                <td class="style26">
                                    <asp:TextBox ID="txt_balance" runat="server" CssClass="input-text" Width="170px" 
                                        Height="28px"></asp:TextBox>
                                </td>
                                    <td class="style27">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                ControlToValidate="txt_balance" ErrorMessage="Balance is Required" 
                                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                                        <br />
                               </td></tr>
